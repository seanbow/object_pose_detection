...
vector<int32_t>
VisualOdometryMono::getInlier(vector<Matcher::p_match> &p_matched, Matrix &F) {
...
int32_t
VisualOdometryMono::triangulateChieral(vector<Matcher::p_match> &p_matched,
                                       Matrix &K, Matrix &R, Matrix &t,
                                       Matrix &X) {
