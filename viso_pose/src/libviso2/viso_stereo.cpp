...
void VisualOdometryStereo::updateCovariance(std::vector<int32_t> &active) {
  ...
  // ...
  // To compute Pn, i.e. P0n, need to update each time with the jacobian of that
  // addition operator
  //
...
Eigen::Matrix<double, 6, 6> VisualOdometryStereo::getCovariance() {
  return dC_;
}

Eigen::Matrix<double, 6, 6> VisualOdometryStereo::getPoseCovariance() {
  return C_;
}

void VisualOdometryStereo::resetPose() {
